...
hideDelay:0,openerClass:"opener",openerActiveClass:"active",submenuClassPrefix:"level-",mode:"fade",speed:"fast",easing:"swing",alignment:"left",offsetX:0,offsetY:0,globalOffsetY:0,IEOffsetX:0,IEOffsetY:0,noOpenerFade:!0,detach:!0,cloneOnDetach:!0},l),f=a.selectorParent,p=f.find("ul"),q=e("html"),g=!1,t=null,r=null;f.on("doCollapseAll",function(){p.trigger("doCollapse")});p.each(function(){var b=e(this),c=b.parent();if(0<a.hideDelay)b.add(c).on("mouseleave",function(d){window.clearTimeout(r);r=
